...
### Rule 1 — Single Connection for High-Frequency SQLite
...
### Rule 2 — Strict Thread Pool and Timeout Limits
...
### Rule 3 — Caching Expensive OS Invocations
...
### Rule 4 — Loop Interval Isolation
...
### Rule 5 — Efficient Video Array Operations
